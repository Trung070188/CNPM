                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{('public/frontend/images/shutterstock_1375838726-860x430.jpg')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="{{('public/frontend/images/471937-microsoft-xbox-one-x.jpg')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="{{('public/frontend/images/123444.jpg')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                         <img src="{{('public/frontend/images/tải xuống.jpg')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
        ...
        <div class="footer-widget">
            <div class="container">
                <div class="row">
                    ...
                    <!-- </div> -->
                    <div class="col-sm-8">
                    <img src="{{('public/frontend/images/slider1.jpg')}}" alt="" />
                    </div>
                    <!-- <div class="col-sm-4">
                    <img src="{{('public/frontend/images/slider1.jpg')}}" alt="" />
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            ...
                            <form action="#" class="searchform">
                                ...
                                <p>Số điện thoại : 0988888888 <br />  Địa chỉ: Đại học giao thông vận tảỉ   <br> Email:Nhom19@gmail.com </br></p>
                            </form>
                        </div>
                    </div>
